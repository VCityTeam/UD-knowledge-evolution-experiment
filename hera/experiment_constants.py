...
constants = types.SimpleNamespace(
    ...
    new_quads_querier = "harbor.pagoda.os.univ-lyon1.fr/ud-evolution/quads-querier:v1.3.0",
    get_workflow_logs = "harbor.pagoda.os.univ-lyon1.fr/ud-evolution/get-workflow-logs:v1.0.0",
    log_to_plots = "harbor.pagoda.os.univ-lyon1.fr/ud-evolution/log-to-plots:v1.0.0",
    repeat = 200,
    cpu_limit = 2,
    memory_request = "4",
    memory_limit = "8",
