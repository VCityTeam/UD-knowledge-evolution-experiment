...
constants = types.SimpleNamespace(
    ...
    log_to_plots = "harbor.pagoda.liris.cnrs.fr/ud-evolution/log-to-plots:v1.1.0",
    space_logs_to_plots = "harbor.pagoda.liris.cnrs.fr/ud-evolution/space-logs-to-plots:v1.1.0",
    repeat = 200,
    cpu_limit = 2,
    memory_request = "4",
    memory_limit = "8",
